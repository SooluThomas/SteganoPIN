...
import com.stegnopinweb.Userinfo;
 ...
 */
@Stateless
@Path("com.stegnopinweb.userinfo")
public class UserinfoFacadeREST extends AbstractFacade<Userinfo> {
    ...
    public void edit(@PathParam("id") Long id, Userinfo entity) {
        super.edit(entity);
    }
    ...
    public Userinfo find(@PathParam("id") Long id) {
