...
import com.stegnopinweb.Transactions;
 ...
 */
@Stateless
@Path("com.stegnopinweb.transactions")
public class TransactionsFacadeREST extends AbstractFacade<Transactions> {
    ...
    public void edit(@PathParam("id") Long id, Transactions entity) {
        super.edit(entity);
    }
    ...
    public Transactions find(@PathParam("id") Long id) {
